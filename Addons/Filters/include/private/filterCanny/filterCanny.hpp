...
#define ORI_SCALE 1
  ...
  static void SeparableConvolution(T1 *imIn,
                                   int Width,
                                   int Height,
                                   float *gau,
                                   int taille,
  ...
  //****************************************************************************
  static void SeparableConvolution_dxy(int Width,
                                       int Height,
                                       float *Image,
                                       float *gau,
                                       int taille,
  ...
  static void
    NonMaxSuppress(int Width, int Height, float *dX, float *dY, T2 *imNorme) {
    int i, j;
